...
function generate_test_functions()
    return Any[
        ...
        (false, nothing, pi_node_tester, Ref{Any}(5.0)),
        (false, nothing, pi_node_tester, Ref{Any}(5)),
        ...
        (false, nothing, type_unstable_tester_3, Ref{Any}(5.0)),
        ...
        (false, nothing, simple_foreigncall_tester_2, randn(6), (2, 3)),
        (false, nothing, foreigncall_tester, randn(5)),
        (false, nothing, no_primitive_inlining_tester, 5.0),
        ...
        (false, nothing, datatype_slot_tester, 1),
        (false, nothing, datatype_slot_tester, 2),
        (
            false,
            nothing,
        ...
        (false, nothing, getfield_tester, (5.0, 5)),
        (false, nothing, getfield_tester_2, (5.0, 5)),
        (
            false, nothing,
            mul!, transpose(randn(3, 5)), randn(5, 5), randn(5, 3), 4.0, 3.0,
        ), # static_parameter,
        (false, nothing, Xoshiro, 123456),
        (false, nothing, *, randn(250, 500), randn(500, 250)),
