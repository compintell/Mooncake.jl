...
@foldable tangent_type(::Type{NoFData}, ::Type{T}) where {T<:Union{NoRData,RData}} = Union{
    NoTangent,tangent_type(T)
}
@foldable tangent_type(::Type{T}, ::Type{NoRData}) where {T<:Union{NoFData,FData}} = Union{
    NoTangent,tangent_type(T)
}
