...
function rrule!!(::CoDual{typeof(+)}, x::CoDual{P}, y::CoDual{S}) where {P<:TWP, S<:IEEEFloat}
...
function generate_hand_written_rrule!!_test_cases(rng_ctor, ::Val{:twice_precision})
    test_cases = Any[
        (
            ...
            _new_, TwicePrecisionFloat{Float64}, 5.0, 4.0
        ),
        ...
        (
            false, :stability_and_allocs, nothing,
            +, TwicePrecision(5.0, 3.0), TwicePrecision(4.0, 5.0),
        ),
        ...
        (
            false, :stability_and_allocs, nothing,
            Base.range_start_step_length, 5.0, Float64(π), 10,
        ),
        (
            false, :stability_and_allocs, nothing,
            unsafe_getindex,
        ...
        (
            false, :stability_and_allocs, nothing,
            Base.range_start_stop_length, -0.5, 11.7, 7,
        ),
        (
            false, :stability_and_allocs, nothing,
