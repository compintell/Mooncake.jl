...
function generate_test_functions()
    return Any[
        ...
        (false, (lb=100, ub=10_000), Xoshiro, 123456),
        ...
        (false, nothing, test_multiple_pi_nodes, Ref{Any}(5.0)),
        (false, nothing, test_multi_use_pi_node, Ref{Any}(5.0)),
        ...
        (false, (lb=10, ub=1_000), sum, randn(30)),
